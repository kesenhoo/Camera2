...
public interface XMPMeta extends Cloneable
{
	 ...
	 * <p>
	 * See {@link com.adobe.xmp.options.PropertyOptions} for detailed information about the options.
	 * <p>
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#setProperty(String, String, Object, com.adobe.xmp.options.PropertyOptions)
	 *  
	 ...
	 *        the last existing item, use {@link com.adobe.xmp.XMPMeta#countArrayItems(String, String)} to find
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#setArrayItem(String, String, int, String, com.adobe.xmp.options.PropertyOptions)
	 *  
	 * @param schemaNS The namespace URI
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#insertArrayItem(String, String, int, String, com.adobe.xmp.options.PropertyOptions)
	 * 
	 ...
	 *        <ul>
	 *        <li> {@link com.adobe.xmp.options.PropertyOptions#ARRAY},
	 *        <li> {@link com.adobe.xmp.options.PropertyOptions#ARRAY_ORDERED},
	 *        <li> {@link com.adobe.xmp.options.PropertyOptions#ARRAY_ALTERNATE} or
	 *        <li> {@link com.adobe.xmp.options.PropertyOptions#ARRAY_ALT_TEXT}.
	 *        </ul>
	 ...
	 *        {@link com.adobe.xmp.XMPMeta#appendArrayItem(String, String, String)}.
	 * @param itemValue the value of the array item. Has the same usage as propValue in getProperty.
	 * @param itemOptions Option flags describing the item to append ({@link com.adobe.xmp.options.PropertyOptions})
	 * @throws XMPException Wraps all errors and exceptions that may occur.
	 */
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#appendArrayItem(String, String, com.adobe.xmp.options.PropertyOptions, String, com.adobe.xmp.options.PropertyOptions)
	 * 
	 * @param schemaNS The namespace URI for the array
	 * @param arrayName The name of the array
	 * @param itemValue the value of the array item
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#setStructField(String, String, String, String, String, com.adobe.xmp.options.PropertyOptions)
	 * 
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#setQualifier(String, String, String, String, String, com.adobe.xmp.options.PropertyOptions)
	 * 
	 * @param schemaNS The namespace URI for the struct
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#setLocalizedText(String, String, String, String, String, com.adobe.xmp.options.PropertyOptions)
	 * 
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#setPropertyBoolean(String, String, boolean, com.adobe.xmp.options.PropertyOptions)
	 *  
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#setPropertyInteger(String, String, int, com.adobe.xmp.options.PropertyOptions)
	 *  
	 * @param  schemaNS The namespace URI for the property
	 * @param  propName The name of the property
	 * @param  propValue the literal property value as <code>int</code>
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#setPropertyLong(String, String, long, com.adobe.xmp.options.PropertyOptions)
	 *  
	 * @param  schemaNS The namespace URI for the property
	 * @param  propName The name of the property
	 * @param  propValue the literal property value as <code>long</code>
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#setPropertyDouble(String, String, double, com.adobe.xmp.options.PropertyOptions)
	 *  
	 * @param  schemaNS The namespace URI for the property
	 * @param  propName The name of the property
	 * @param  propValue the literal property value as <code>double</code>
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#setPropertyDate(String, String, XMPDateTime, com.adobe.xmp.options.PropertyOptions)
	 *  
	 * @param  schemaNS The namespace URI for the property
	 * @param  propName The name of the property
	 * @param  propValue the property value as <code>XMPDateTime</code>
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#setPropertyCalendar(String, String, java.util.Calendar, com.adobe.xmp.options.PropertyOptions)
	 *  
	 * @param  schemaNS The namespace URI for the property
	 * @param  propName The name of the property
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#setPropertyBase64(String, String, byte[], com.adobe.xmp.options.PropertyOptions)
	 *  
	 * @param  schemaNS The namespace URI for the property
	 * @param  propName The name of the property
	 * @param  propValue the literal property value as byte array
	 ...
	 * @see com.adobe.xmp.XMPMeta#iterator(String, String, com.adobe.xmp.options.IteratorOptions)
	 * @throws XMPException Wraps all errors and exceptions that may occur.
	 */
	 ...
	 * @param options Option flags to control the iteration. See {@link com.adobe.xmp.options.IteratorOptions} for
	 *        details.
	 ...
	 * {@link com.adobe.xmp.options.ParseOptions#OMIT_NORMALIZATION} is set to <code>true</code>.
